...
import com.seyed.ali.reportsservice.config.EurekaClientTestConfiguration;
...
public class TestControllerTest {
    ...
    public void helloTest_AccessDenied() throws Exception {
        ...
        resultActions.andDo(print())
                ...
                .andExpect(jsonPath("$.code", is(HttpStatus.FORBIDDEN.toString())))
                .andExpect(jsonPath("$.message", is("No permission.")))
                .andExpect(jsonPath("$.server_message", is("Access Denied")))
        ;
    }
